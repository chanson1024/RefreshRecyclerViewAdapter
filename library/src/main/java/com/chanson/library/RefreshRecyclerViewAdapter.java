...
public abstract class RefreshRecyclerViewAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    private static final String TAG = "RefreshRecyclerViewAdapter";
    ...
    public RefreshRecyclerViewAdapter(Context context, List<T> data) {
